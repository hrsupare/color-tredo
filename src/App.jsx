...
const App = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-8 p-6 bg-gradient-to-b from-gray-50 to-gray-100 rounded-xl shadow-md w-full max-w-md mx-auto transition-all duration-500">
      <Routes > 
